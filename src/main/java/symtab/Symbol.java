 ...
 * A symbol has to have a name and a scope in which it lives.
 * It also helps to know the order in which symbols are added to a scope
 * because this often translates to register or parameter numbers.
 */
