 ...
 * Each member has a slot number indexed from 0,
 * and we track data fields and methods with different slot sequences.
 * A DataAggregateSymbol can also be a member of an aggregate itself
 * (nested structs, ...).
 */
public abstract class DataAggregateSymbol extends SymbolWithScope implements MemberSymbol, Type {
	 ...
	 * Return any kind of MemberSymbol found
