 ...
 * It is a kind of data aggregate that has much in common with a struct.
 */
public class ClassSymbol extends DataAggregateSymbol {
	...
	/**
	 * Return the ClassSymbol associated with superClassName
	 * or null if superclass is not resolved looking up the enclosing scope chain.
	 */
